...
<template>
  <Transition name="drawer-slide">
    <aside
      v-if="open"
      class="flex h-full w-[460px] flex-shrink-0 flex-col border-l border-surface-border bg-white shadow-[-12px_0_32px_rgba(31,35,41,0.08)]"
    >
      <header class="flex h-14 flex-shrink-0 items-center gap-3 border-b border-surface-border px-4">
      ...
      <div class="min-h-0 flex-1 bg-surface-hover">
        ...
        <template v-else-if="preview">
          ...
          <div v-else-if="preview.previewKind === 'image' && preview.dataUrl" class="flex h-full items-center justify-center p-4">
            <img
              :src="preview.dataUrl"
          ...
          <div v-else-if="preview.previewKind === 'audio' && preview.dataUrl" class="flex h-full items-center justify-center p-6">
            <audio class="w-full" controls :src="preview.dataUrl"></audio>
          </div>

          <div v-else-if="preview.previewKind === 'video' && preview.dataUrl" class="flex h-full items-center justify-center bg-black p-4">
